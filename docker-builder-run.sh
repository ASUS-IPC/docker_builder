...
DOCKER_IMAGE="asus/yocto-3.3-builder:latest"
...
OPTIONS+=" --volume $DIRECTORY_PATH_TO_SOURCE:/source --volume $HOME/yocto-3.3/share:$HOME/yocto-3.3/share"
